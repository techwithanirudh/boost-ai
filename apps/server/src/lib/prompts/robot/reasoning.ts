...
5. Speed: Prefer lower speeds (0.3–0.5) by default; use up to 0.7 only on very clear, open paths.

Step size policy:
- Default to small steps: 0.05–0.3 m for careful navigation.
- Use up to 1 m only when the path is visually confirmed wide-open ahead.
