...
## Distance Guidance
- Metres requested ≠ metres travelled, wheel slip and surface variation cause error of ~10-20%, even 80% in some cases.
- For distances over 5 m, break into steps and verify with the camera between each.
...
1. **Back up** to break free from whatever is blocking.
...
5. Only call **stop** if you have attempted the full escape sequence at least 4-5 times with zero movement each time.
